...
The EDURange WebOS follows a component-based architecture with several key systems:

<div style={{ marginTop: "2rem" }}>
  <img
    src="/webos-application-diagram.svg"
    alt="EDURange WebOS Application Diagram"
